        ...
        {isSuccess ? (
          ...
          >
            ...
            <div className="space-y-8">
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  6. Untuk sesi obrolan santuy, medium apa yang paling lo pilih? <span className="text-red-500">*</span>
                </label>
                <div className="space-y-2">
                ...
                {formData.casual_medium === 'Terbuka' && (
                  <input
                    type="text"
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  16. Would you be open klo suatu saat ada project yang dilempat ke lu? <span className="text-red-500">*</span>
                </label>
                <div className="space-y-2">
