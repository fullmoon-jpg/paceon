...
const CommunitySensingPage = () => {
  ...
  const yesNoMaybeOptions = ["Iya", "Mungkin", "Tidak"];

  const projectOpennessOptions = ["Iya", "Tergantung projectnya", "Tidak"];
      ...
      <div className="max-w-3xl mx-auto px-6 sm:px-8">
        <div className="mb-10 text-center">
          ...
          <p className="font-body text-base sm:text-lg text-[#3f3e3d]/80 max-w-2xl mx-auto leading-relaxed">
            Bantu kami memahami kebutuhan dan preferensi lo untuk membangun
        ...
        {isSuccess ? (
          <div className="border-2 border-green-200 rounded-3xl p-8 sm:p-10 text-center bg-green-50/30">
            ...
            <p className="font-body text-sm sm:text-base text-[#3f3e3d]/80 mb-6 leading-relaxed">
              Respons lo udah berhasil dikirim. Feedback lo sangat berharga
              untuk perkembangan komunitas PACE ON!
            </p>
            <button
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <input
                  ...
                  required
                  className={`w-full text-[#3f3e3d] pb-2 border-b-2 ${getBorderColor(
                    formData.full_name
                  )} font-body text-base transition-all bg-transparent outline-none placeholder:text-[#3f3e3d]/40`}
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="Nama perusahaan / community"
                />
              </div>
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  4. Seberapa sering menurut lo idealnya komunitas ini
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  5. Dalam komunitas ini, lo lebih enjoy obrolan seperti apa?{" "}
                  <span className="text-red-500">*</span>
                </label>
                <div className="space-y-2">
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  7. Untuk sesi yang membahas bisnis secara lebih serius,
                  format apa yang paling lo suka?{" "}
                  ...
                  {seriousFormatOptions.map((option) => (
                    ...
                    >
                      <input
                        ...
                        onChange={() =>
                          handleCheckboxChange("serious_format", option)
                        }
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  8. Jika ada pertemuan offline, lokasi mana yang paling
                  nyaman buat lo?{" "}
                  <span className="text-red-500">
                    * (Bisa pilih lebih dari satu)
                  </span>
                ...
                <div className="grid grid-cols-2 gap-3 pl-1">
                  {locationOptions.map((option) => (
                    ...
                    >
                      <input
                        type="checkbox"
                        checked={formData.preferred_locations.includes(
                          option
                        )}
                        onChange={() =>
                          handleCheckboxChange("preferred_locations", option)
                        }
                        className="mt-1 w-4 h-4 rounded border-2 border-gray-300 text-[#21C36E] focus:ring-[#21C36E] focus:ring-2 cursor-pointer"
                      />
                      <span className="font-body text-sm text-[#3f3e3d] group-hover:text-[#21C36E] transition-colors">
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  9. Apa yang sedang lo cari saat ini, dan hal apa yang lo
                  harapkan bisa dibantu PACE ON, baik secara personal maupun
                  bisnis? <span className="text-red-500">*</span>
                </label>
                <textarea
                  name="current_needs"
                  ...
                  rows={4}
                  className={`w-full text-[#3f3e3d] pb-2 border-b-2 ${getBorderColor(
                    formData.current_needs
                  )} resize-none font-body text-base transition-all bg-transparent outline-none placeholder:text-[#3f3e3d]/40`}
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  11. Kalau ada small group di dalam komunitas, grup seperti
                  apa yang paling ingin lo ikuti?{" "}
                  <span className="text-red-500">*</span>
                  <span className="block text-xs text-[#3f3e3d]/60 mt-1 font-body">
                    Contoh: olahraga, game, industri bisnis, dll
                  </span>
                </label>
                <textarea
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  12. Apa harapan dan keinginan utama lo terhadap komunitas
                  ini ke depannya? <span className="text-red-500">*</span>
                </label>
                <textarea
              ...
              {/* 14. Founder Content Interest */}
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  14. Apakah lo tertarik untuk mengikuti atau masuk ke konten
                  seputar founder journey?{" "}
                  <span className="text-red-500">*</span>
                </label>
                <div className="space-y-2">
                  {yesNoMaybeOptions.map((option) => (
                    ...
                    >
                      <input
                        ...
                        value={option}
                        checked={
                          formData.founder_content_interest === option
                        }
                        onChange={handleChange}
                        className="w-4 h-4 text-[#21C36E] focus:ring-[#21C36E] focus:ring-2 cursor-pointer"
                      />
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  15. Would you be open klo suatu saat ada project yang
                  dilempar ke lu? <span className="text-red-500">*</span>
                </label>
                <div className="space-y-2">
              ...
              <div>
                <label className="font-brand block text-sm text-[#3f3e3d] mb-3">
                  16. Boleh share logo perusahaan lo untuk kebutuhan
                  dokumentasi & kolaborasi komunitas?{" "}
                  <span className="text-red-500">*</span>
                </label>
                    ...
                    <div className="relative">
                      ...
                      >
                        <div className="flex flex-col items-center justify-center pt-5 pb-6">
                          <svg
                            className="w-12 h-12 mb-4 text-[#3f3e3d]/40 group-hover:text-[#21C36E] transition-colors"
                            fill="none"
                            stroke="currentColor"
                            viewBox="0 0 24 24"
                          >
                        ...
                        <div className="flex-1">
                          ...
                          <p className="font-body text-xs text-[#3f3e3d]/60">
                            {formData.company_logo &&
                              (formData.company_logo.size / 1024).toFixed(
                                2
                              )}{" "}
                            KB
                          </p>
