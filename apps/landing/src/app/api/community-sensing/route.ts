...
export async function POST(request: NextRequest): Promise<NextResponse<ApiResponse>> {
  try {
    ...
    const responseData: FormData = {
      ...
      gathering_frequency_other: formData.get('gathering_frequency_other') as string || undefined,
      conversation_type: formData.get('conversation_type') as string,
      casual_medium: formData.get('casual_medium') as string,
      casual_medium_other: formData.get('casual_medium_other') as string || undefined,
      serious_format: JSON.parse(formData.get('serious_format') as string),
      serious_format_other: formData.get('serious_format_other') as string || undefined,
      preferred_locations: JSON.parse(formData.get('preferred_locations') as string),
      current_needs: formData.get('current_needs') as string,
      gathering_topic: formData.get('gathering_topic') as string,
      gathering_topic_other: formData.get('gathering_topic_other') as string || undefined,
      ...
      price_community_gathering: formData.get('price_community_gathering') as string,
      price_sports_activity: formData.get('price_sports_activity') as string,
      price_fgd: formData.get('price_fgd') as string,
      podcast_interest: formData.get('podcast_interest') as string,
      founder_content_interest: formData.get('founder_content_interest') as string,
