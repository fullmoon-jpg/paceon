...
const TalkNTalesHero = () => {
  ...
  const countdownUnit = (val: number, label: string) => (
    <div style={{ textAlign: "center" }}>
      <div style={{ fontFamily: "'Alfa Slab One', serif", fontSize: "clamp(22px, 3.5vw, 42px)", color: "#fff", lineHeight: 1 }}>
        {pad(val)}
      </div>
      <div style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: "clamp(8px, 0.9vw, 11px)", color: "#E8C12A", textTransform: "uppercase", letterSpacing: "0.2em", marginTop: "4px" }}>
        {label}
      </div>
    </div>
  );
    ...
    <>
      ...
      >
        ...
        >
          ...
          <div
            className="absolute hidden md:flex flex-col items-end"
            style={{ right: "clamp(24px, 4vw, 56px)", top: "clamp(16px, 3vh, 32px)", gap: "0px" }}
          >
          ...
          >
            ...
            <span style={{ fontFamily: "'Shrikhand', serif", fontSize: "clamp(9px, 1vw, 13px)", color: "#fff", textTransform: "uppercase", letterSpacing: "0.05em", textAlign: "center", lineHeight: 1.4, marginTop: "2px" }}>
              GenZ<br />Founders
            </span>
          </div>
          ...
          >
            <Image
              src="/images/logo-tnt2.png"
              alt="Talk N Tales #2 — Offline Networking Event for GenZ Founders"
              fill
          ...
          <button
            ...
            style={{
              ...
              padding: "clamp(10px, 1.5vh, 16px) clamp(20px, 2.5vw, 36px)",
              cursor: "pointer",
            ...
            onMouseEnter={(e) => {
              ...
              el.style.boxShadow = "6px 6px 0px #E8C12A";
            }}
            onMouseLeave={(e) => {
              const el = e.currentTarget;
              el.style.background = "#E8C12A";
          ...
          {/* Bottom info */}
          <div
            className="absolute bottom-0 left-0 right-0 flex items-end justify-between flex-wrap gap-4 px-6 md:px-10 lg:px-16"
            style={{ paddingBottom: "clamp(14px, 2.5vh, 24px)" }}
          >
            <div style={{ textAlign: "left" }}>
              <div style={{ fontFamily: "'Alfa Slab One', serif", fontSize: "clamp(16px, 2.5vw, 28px)", color: "#fff", lineHeight: 1.1, textTransform: "uppercase" }}>
                9 <span style={{ color: "#E8C12A" }}>•</span> Mei{" "}
                <span style={{ color: "#E8C12A" }}>•</span> 2026
              </div>
        ...
        {/* Bottom Bar */}
        <div
          className="shrink-0 flex items-center justify-between flex-wrap gap-2 px-6 md:px-10 lg:px-16"
          style={{ background: "#E8121A", paddingTop: "12px", paddingBottom: "12px" }}
        >
          <span style={{ fontFamily: "'Poppins', sans-serif", fontWeight: 700, fontSize: "clamp(9px, 1vw, 12px)", color: "#fff", textTransform: "uppercase", letterSpacing: "0.2em" }}>
            Offline Networking Event
          </span>
          <span style={{ fontFamily: "'Alfa Slab One', serif", fontSize: "clamp(11px, 1.2vw, 15px)", color: "#E8C12A", textTransform: "uppercase" }}>
            Founder Only ✦
          </span>
        </div>
      </section>
